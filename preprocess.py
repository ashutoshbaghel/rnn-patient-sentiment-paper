        ...
        with open(f) as tsv:
            for line in csv.reader(tsv, dialect="excel-tab"):
                ...
                if(len(line) > 6 and RepresentsInt(line[3]) and RepresentsInt(line[5]) and RepresentsInt(line[6]) ):
                    ...
                    text.append(line[2])
                    staff.append(line[3])
                    helpful.append(line[5])
                    knowledge.append(line[6])
                    # TO-DO Create labels for staff, helpful and knowledge for binary classifications
                else: 
                    pass
                    # write reject lines to a file for analyzing later
        
        
print "helful:", len(helpful)
...
# f1=open('./testfile2.text','w+')
# print "hihihihi"
# print len(helpfull_test)
# for kkkk in helpfull_test:
#     print kkkk
#     f1.write(str(kkkk))
#     f1.write('\n')
# print "ending"
